...
class LaunchRequestHandler(AbstractRequestHandler):
    def can_handle(self, handler_input):
        print("> LaunchRequestHandler__can_handle")
...
class CatchAllExceptionHandler(AbstractExceptionHandler):
    def can_handle(self, handler_input, exception):
        print("> CatchAllExceptionHandler__can_hanlde")
        return True
...
class AnimalChinesIntentHandler(AbstractRequestHandler):
    def can_handle(self, handler_input):
        print("> AnimalChinesIntentHandler__can_handle")
        return is_intent_name("AnimalChinesIntent")(handler_input)

    def handle(self, handler_input, exception):
        print("> AnimalChinesIntentHandler")
